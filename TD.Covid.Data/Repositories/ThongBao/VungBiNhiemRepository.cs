...
{
    public class VungBiNhiemRepository : Repository<VungBiNhiem>, IVungBiNhiemRepository
    {
        private readonly CovidDataContext _context;
        private readonly ICoreContextAccessor _coreContextAccessor;
        public VungBiNhiemRepository(CovidDataContext context, ICoreContextAccessor coreContextAccessor)
