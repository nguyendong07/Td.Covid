...
{
    public class LichSuLuuTruRepository : Repository<LichSuLuuTru>, ILichSuLuuTruRepository
    {
        private readonly CovidDataContext _context;
        private readonly ICoreContextAccessor _coreContextAccessor;
        public LichSuLuuTruRepository(CovidDataContext context, ICoreContextAccessor coreContextAccessor)
