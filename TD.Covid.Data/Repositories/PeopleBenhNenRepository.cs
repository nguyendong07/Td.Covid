...
{
    public class PeopleBenhNenRepository : Repository<PeopleBenhNen>, IPeopleBenhNenRepository
    {
        private readonly CovidDataContext _context;
        private readonly ICoreContextAccessor _coreContextAccessor;
        public PeopleBenhNenRepository(CovidDataContext context, ICoreContextAccessor coreContextAccessor)
