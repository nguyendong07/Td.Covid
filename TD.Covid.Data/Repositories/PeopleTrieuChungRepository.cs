...
{
    public class PeopleTrieuChungRepository : Repository<PeopleTrieuChung>, IPeopleTrieuChungRepository
    {
        private readonly CovidDataContext _context;
        private readonly ICoreContextAccessor _coreContextAccessor;
        public PeopleTrieuChungRepository(CovidDataContext context, ICoreContextAccessor coreContextAccessor)
