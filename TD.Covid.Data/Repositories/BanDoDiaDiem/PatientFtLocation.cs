...
{
    public class PatientFtLocationRepository : Repository<PatientFtLocation>, IPatientFtLocationRepository
    {
        private readonly CovidDataContext _context;
        private readonly ICoreContextAccessor _coreContextAccessor;
        public PatientFtLocationRepository(CovidDataContext context, ICoreContextAccessor coreContextAccessor)
