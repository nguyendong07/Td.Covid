...
{
    public class DanTocRepository : Repository<DanToc>, IDanTocRepository
    {
        private readonly CovidDataContext _context;
        private readonly ICoreContextAccessor _coreContextAccessor;
        public DanTocRepository(CovidDataContext context, ICoreContextAccessor coreContextAccessor)
